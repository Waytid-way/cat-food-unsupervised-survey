...
from catfood_unsupervised.shared.paths import RAW_DATA_PATH, UNSUPERVISED_OUTPUT_DIR
from catfood_unsupervised.shared.survey_values import THAI_LIKERT_SCALE, map_series_values
from catfood_unsupervised.unsupervised.data_loading import (
    filter_completed_responses,
    load_raw_export,
)
from catfood_unsupervised.unsupervised.features import build_vote_features, ipsatize_rows
from catfood_unsupervised.unsupervised.models import (
...
def run_pipeline(
    ...
    *,
    ...
    if output_dir is None:
        output_dir = UNSUPERVISED_OUTPUT_DIR
